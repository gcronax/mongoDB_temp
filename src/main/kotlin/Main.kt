...
fun mostrarCoches() {
    ...
    coleccionCoches.find().forEach { doc ->
        ...
        println("[$id_coche] $modelo ($marca): $consumo $hp")
    }
}
...
//                    exportarBD(coleccion,"/home/guicamher/IdeaProjects/MngoKT/src/main/resources/cars.json")
//                }
//                7 -> {
//                    itera = false
//                }
//
//                else -> {
//                    println("Opcion no valida. Por favor, selecciona una opcion del 1 al 7.")
//                }
//            }
//
